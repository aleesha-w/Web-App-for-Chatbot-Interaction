    ...
    if (inputValue.trim()) {
      ...
      console.log("Attempting to send request2");
          const response = await fetch('http://localhost:3000/', {
              ...
              body: JSON.stringify({ question: inputValue, modulNum: 3 })
          });
        ...
        setMessages(messages.concat({ user: 'BERT-DPT', text: 'Error fetching response' }));
      }
      setInputValue('');
    }
  };
