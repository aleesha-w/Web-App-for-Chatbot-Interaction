    ...
    if (inputValue.trim()) {
      ...
      console.log("Attempting to send request2");
          const response = await fetch('http://localhost:3000/', {
              ...
              body: JSON.stringify({ question: inputValue, modulNum: 1 })
          });
        ...
        setMessages(messages.concat({ user: 'BERT-FP', text: 'Error fetching response' }));
      }
      setInputValue('');
    }
  };
